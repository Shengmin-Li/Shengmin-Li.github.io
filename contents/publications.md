<div class="publication-list">
  <article class="publication-card publication-card-featured" data-category="journal" data-status="under-review">
    ...
    <div class="publication-content">
      <div class="publication-heading">
        <span class="publication-tag">TC</span>
        <h3>FlexVector: A SpMM Vector Processor with Flexible VRF for GCNs on Varying-Sparsity Graphs</h3>
      </div>
